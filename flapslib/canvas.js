...
function weezer(msg, client) {
    ...
    canvas
        .loadImage(__dirname + "./../images\\weezer1.png")
        .then(async(weez1) => {
            canvas
                .loadImage(__dirname + "./../images\\weezer2.png")
                .then(async(weez2) => {
                    canvas
                        .loadImage(__dirname + "./../images\\weezer3.png")
                        .then(async(weez3) => {
                            canvas
                                .loadImage(__dirname + "./../images\\weezer4.png")
                                .then(async(weez4) => {
                                    canvas
                                        .loadImage(__dirname + "./../images\\weezer5.png")
                                        .then(async(weez5) => {
                                            canvas
                                                .loadImage(__dirname + "./../images\\weezer6.png")
                                                .then(async(weez6) => {
                                                    canvas
                                                        .loadImage(__dirname + "./../images\\weezer7.png")
                                                        .then(async(weez7) => {
                                                            canvas
                                                                .loadImage(
                                                                    __dirname + "./../images\\weezer8.png"
                                                                )
                                                                .then(async(weez8) => {
                                                                    ctx.fillStyle =
                                                                        "#" +
                                                                    ...
                                                                    var randomImage =
                                                                        weezes[
                                                                            Math.floor(Math.random() * weezes.length)
                                                                        ];
                                                                    ...
                                                                    for (let i = 0; i < y; i++) {
                                                                        ...
                                                                        var possibleTextPlaces = [
                                                                            ...
                                                                            [w - tw, h - 5],
                                                                            [
                                                                                Math.floor(Math.random() * (w - tw)),
                                                                                Math.floor(
                                                                                    Math.random() * (h - 5 + 30) - 30
                                                                                ),
                                                                            ],
                                                                            [
                                                                                Math.floor(Math.random() * (w - tw)),
                                                                        ...
                                                                        var chosenPlace =
                                                                            possibleTextPlaces[
                                                                                Math.floor(
                                                                                    Math.random() *
                                                                                    possibleTextPlaces.length
                                                                                )
                                                                            ];
                                                                        if (
                                                                            takenIndexes.includes(
                                                                                possibleTextPlaces.indexOf(chosenPlace)
                                                                            )
                                                                        ) {
                                                                            y++;
                                                                            continue;
