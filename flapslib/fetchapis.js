                                    ...
                                    var embed = new Discord.MessageEmbed()
                                        ...
                                        .setAuthor({
                                            name: post.name
                                                ...
                                                : "Author",
                                            iconURL:
                                                "https://res.cloudinary.com/crunchbase-production/image/upload/c_lpad,h_256,w_256,f_auto,q_auto:eco,dpr_1/v1506977414/y31m3uyt8lskvx7rlmjo.png",
                                        })
                                        .addFields(
                                            {
                                                name: "Replies",
            ...
            (_err, data) => {
                fetch("https://www.instapainting.com/updates/create-chunked/", {
                    ...
                    headers: {
                        ...
                        "Content-Type":
                            "multipart/form-data; boundary=---------------------------350767340815892917253934287128",
